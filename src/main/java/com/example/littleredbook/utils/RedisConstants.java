...
public class RedisConstants {
    ...
    public static final String CACHE_USER_KEY = "littleredbook:cache:user:";
    ...
    public static final String CACHE_TAGLIST_KEY = "littleredbook:cache:tag:list";
    public static final String CACHE_NOTELIST_KEY = "littleredbook:cache:note:list";
    ...
    public static final String CACHE_BROWSE_KEY = "littleredbook:cache:browse:";
